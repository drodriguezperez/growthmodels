...
#' Vanclay growth model
#'
#' Computes the Vanclay growth model
...
#' 
#' @usage vanclay(t, alpha, beta, k, m)
#' 
#' @examples
#' growth <- vanclay(0:10, 10, 0.5, 0.3, 0.5)
#' 
#' @rdname vanclay
#' @export vanclay
#' @aliases vanclay
vanclay <- function(t, alpha, beta, k, m) {
